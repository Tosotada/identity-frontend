...
object ErrorViewModel {
  ...
  val errorMessages: Map[ErrorID, String] = Map(
    ...
    RegisterEmailConflictErrorID -> "Looks like you may already have a Guardian account. Please sign in, set or reset your password or use a different email address.",
    RegisterEmailConflictHydratedErrorID -> "Looks like you may already have a Guardian account. Please {0}, {1} or use a different email address.",
