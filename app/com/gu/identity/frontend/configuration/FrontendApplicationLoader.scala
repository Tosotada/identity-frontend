...
class ApplicationComponents(context: Context)
  ...
  lazy val thirdPartyTsAndCsController = new ThirdPartyTsAndCs(identityService, frontendConfiguration, httpErrorHandler, userAuthenticatedAction, controllerComponents)
