...
class UnsubscribeControllerTest extends FlatSpec with Matchers {
  ...
  "findConsentWording" should "find consent wording for an unsubscribe request" in {
    UnsubscribeRequest.findConsentWording(UnsubscribeApiRequest("marketing", "jobs", "100", 123l, "token")) shouldBe Some("Jobs")
  }

  "findConsentWording" should "return None for unknown consent type" in {
    UnsubscribeRequest.findConsentWording(UnsubscribeApiRequest("marketing", "unknown", "100", 123l, "token")) shouldBe None
  }
}
